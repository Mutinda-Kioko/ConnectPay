...
import { Modal, useModal, Button, Text, Table, Row, Col, Tooltip, User } from "@nextui-org/react";
  ...
  const users = [
    {
      id: 1,
      name: "Tony Reichert",
      team: "Hello I tressure you alot...",
      status: "active",
      age: "29",
  ...
  return (
    <div>
      ...
      >
        ...
        <Modal.Body>
            <Table
        aria-label="Your gift dashboard"
        css={{
        height: "auto",
        minWidth: "100%",
      }}
    ...
    >
      ...
      <Table.Body items={users}>
        ...
        <Modal.Footer>
          ...
          <Button onClick={() => setVisible(false)}>Withdraw</Button>
        </Modal.Footer>
      </Modal>
    </div>
  );
